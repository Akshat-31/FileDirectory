...
Server4-> Creates a local path and downloads and responde with OK fileSize
Server1->Sends the confirmation
Server4-> Sends the file content
*/
...
Server4-> Creates a local path and removes the file and sends the response to client
*/
